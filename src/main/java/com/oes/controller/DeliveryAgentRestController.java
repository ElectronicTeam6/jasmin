...
//	public ResponseEntity<MyDTO> getAllOrderBycity(@PathVariable String city)throws Exception
//	{
//		
//			User user = profileService.getUserById(city);
//			
...
//	@GetMapping("/sort/orderDate/{orderDate}")
//	public List<OnlineOrder> allOnlineOrderSortingByDate()throws Exception{
//		return onlineOrderService.allOnlineOrderSortByDate();
//		
//	}
